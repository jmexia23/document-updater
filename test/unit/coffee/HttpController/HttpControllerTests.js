...
describe("HttpController", function() {
	...
	describe("flushAndDeleteDoc", function() {
		...
		describe("successfully", function() {
			beforeEach(function() {
				this.DocumentManager.flushAndDeleteDocWithLock = sinon.stub().callsArgWith(2);
				return this.HttpController.flushAndDeleteDoc(this.req, this.res, this.next);
			});
		...
		return describe("when an errors occurs", function() {
			beforeEach(function() {
				this.DocumentManager.flushAndDeleteDocWithLock = sinon.stub().callsArgWith(2, new Error("oops"));
				return this.HttpController.flushAndDeleteDoc(this.req, this.res, this.next);
			});
